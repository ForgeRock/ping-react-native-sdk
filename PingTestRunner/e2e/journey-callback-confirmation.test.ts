...
/**
 * E2E — Journey ConfirmationCallback (Tier 2 — server required)
 * Android parity: ConfirmationCallbackE2ETest
 * Server journey tree: ConfirmationCallbackTest
 *
 * Flow:
 *   1. Page Node     → NameCallback:0 + PasswordCallback:0  (login)
 *   2. Message Node  → ConfirmationCallback:0 [Yes=0, No=1]
