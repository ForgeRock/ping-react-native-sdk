...
/**
 * E2E — Journey ChoiceCallback (Tier 2 — server required)
 * Android parity: ChoiceCallbackE2ETest
 * Server journey tree: ChoiceCallbackTest
 *
 * Flow:
 *   1. Page Node        → NameCallback:0 + PasswordCallback:0  (login)
 *   2. Choice Collector → ChoiceCallback:0 [Yes=0, No=1]
...
describe('Journey — ChoiceCallback', () => {
