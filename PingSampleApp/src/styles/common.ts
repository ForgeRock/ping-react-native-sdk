...
export const commonStyles = StyleSheet.create({
  ...
  deviceAuthSectionHeading: {
    fontSize: 17,
    fontWeight: '600',
    color: colors.textDark,
    textAlign: 'center',
  },
  deviceAuthSectionCaption: {
    fontSize: 15,
    color: colors.userProfileSubText,
    textAlign: 'center',
    marginTop: 6,
