...
class RNPingFidoPackage : BaseReactPackage() {
   ...
   * @return FIDO classic module instance when the name matches, otherwise null.
   */
  override fun getModule(name: String, reactContext: ReactApplicationContext): NativeModule? {
    return if (name == RNPingFidoClassicModule.NAME) RNPingFidoClassicModule(reactContext) else null
  }
