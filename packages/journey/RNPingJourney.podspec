...
Pod::Spec.new do |s|
  ...
  s.test_spec "Tests" do |test_spec|
    ...
    test_spec.dependency "PingJourney", '2.1.0'
    test_spec.dependency "PingJourneyPlugin", '2.1.0'
    test_spec.dependency "PingFido", '2.1.0'
    test_spec.dependency "PingDavinciPlugin", '2.1.0'
