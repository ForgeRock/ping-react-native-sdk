...
/**
 * Registers the Device Profile TurboModule package for New Architecture builds.
 */
class RNPingDeviceProfilePackage : BaseReactPackage() {
   ...
   * @return Device Profile TurboModule instance when the name matches, otherwise null.
   */
