...
/**
 * Classic (Old Architecture) entry point for the OATH API on Android.
 *
 * @remarks
 * Mirrors [RNPingOathModule] for legacy React Native setups and forwards
 * all work to [RNPingOathCommon] to keep behaviour consistent.
 *
 * @param reactContext The React Native application context.
 */
@ReactModule(name = RNPingOathClassicModule.NAME)
class RNPingOathClassicModule(
  ...
  companion object {
    ...
    const val NAME = "RNPingOathClassic"
  }
