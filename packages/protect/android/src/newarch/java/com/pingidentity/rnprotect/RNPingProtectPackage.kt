...
/**
 * Registers the Protect TurboModule package for New Architecture builds.
 */
class RNPingProtectPackage : BaseReactPackage() {
   ...
   *
   * @return Provider for Protect module info.
   */
  override fun getReactModuleInfoProvider(): ReactModuleInfoProvider {
    return ReactModuleInfoProvider {
      val moduleInfos: MutableMap<String, ReactModuleInfo> = HashMap()
      moduleInfos[RNPingProtectModule.NAME] = ReactModuleInfo(
        RNPingProtectModule.NAME,
        RNPingProtectModule.NAME,
        false,
        false,
        false,
