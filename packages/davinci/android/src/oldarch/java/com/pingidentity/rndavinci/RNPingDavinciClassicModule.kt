...
/**
 * Classic (Old Architecture) entry point for the DaVinci API on Android.
 *
 * All operations are delegated to [RNPingDavinciCommon] for shared implementation.
 *
 * @param reactContext The React Native application context.
 */
@ReactModule(name = RNPingDavinciClassicModule.NAME)
class RNPingDavinciClassicModule(
