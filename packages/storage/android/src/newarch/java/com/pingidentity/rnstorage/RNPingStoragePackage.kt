...
/**
 * Registers the Storage TurboModule package for New Architecture builds.
 */
class RNPingStoragePackage : BaseReactPackage() {
   ...
   * @return Storage TurboModule instance when the name matches, otherwise null.
   */
  override fun getModule(name: String, reactContext: ReactApplicationContext): NativeModule? {
    return if (name == RNPingStorageModule.NAME) RNPingStorageModule(reactContext) else null
  }
