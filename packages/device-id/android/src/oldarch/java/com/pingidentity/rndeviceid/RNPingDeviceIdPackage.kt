...
/**
 * Registers the Device ID classic module package for Old Architecture builds.
 */
class RNPingDeviceIdPackage : BaseReactPackage() {
   ...
   * @return Device ID classic module instance when the name matches, otherwise null.
   */
