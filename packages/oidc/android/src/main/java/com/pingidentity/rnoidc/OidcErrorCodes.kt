...
object OidcErrorCodes {
  ...
  const val OIDC_DEVICE_AUTHORIZE_ERROR = "OIDC_DEVICE_AUTHORIZE_ERROR"
  const val OIDC_DEVICE_USER_ERROR = "OIDC_DEVICE_USER_ERROR"
  const val OIDC_DEVICE_TOKEN_ERROR = "OIDC_DEVICE_TOKEN_ERROR"
  const val OIDC_DEVICE_REFRESH_ERROR = "OIDC_DEVICE_REFRESH_ERROR"
  const val OIDC_DEVICE_USERINFO_ERROR = "OIDC_DEVICE_USERINFO_ERROR"
  const val OIDC_DEVICE_REVOKE_ERROR = "OIDC_DEVICE_REVOKE_ERROR"
  const val OIDC_DEVICE_LOGOUT_ERROR = "OIDC_DEVICE_LOGOUT_ERROR"
}
