...
final class RNPingLoggerImplTests: XCTestCase {
  ...
  func testSyncLoggerUpdatesLevel() async {
    ...
    let level = await waitForLevel(id, expectedLevel: "WARN")
  ...
  private func waitForLevel(_ id: String, expectedLevel: String? = nil, timeout: TimeInterval = 2.0) async -> String? {
    ...
    return await loggerImpl._testLevel(id)
  }
}
